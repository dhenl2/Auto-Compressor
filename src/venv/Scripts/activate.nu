...
let virtual-env = "\\sshfs\dhenl2@192.168.20.28\Auto-Compressor\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "\\sshfs\dhenl2@192.168.20.28\Auto-Compressor\venv\Scripts\deactivate.nu"
